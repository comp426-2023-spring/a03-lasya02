...
function rpsls(shot){
    ...
    if ((userSide == "scissors" && otherSide == "paper") || (userSide == "rock" && otherSide == "lizard") || (userSide == "paper" && otherSide == "rock") || (userSide == "lizard" && otherSide == "spock") || (userSide == "spock" && otherSide == "scissors") || (userSide == "scissors" && otherSide == "lizard") || (userSide == "lizard" && otherSide == "paper") || (userSide == "paper" && otherSide == "spock") || (userSide == "spock" && otherSide == "rock") || (userSide == "rock" && otherSide == "scissors")  ){
        result = "win"; 
    }
    else if (userSide == otherSide){
        result = "tie"; 
